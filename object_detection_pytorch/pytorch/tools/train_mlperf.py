...
import sys
sys.path.append("/projects/I20240005/rnouaj/recovered_from_git/Results_workloads_deucalion/object_detection_speedy/pytorch")
        ...
        if is_main_process():
            with open("epoch_accuracy_log.csv", "a", newline="") as f:
                ...
                if epoch == 0 and f.tell() == 0:
                    writer.writerow(["Epoch", "bbox_mAP", "segm_mAP"])
                writer.writerow([epoch, bbox_map, segm_map])
