...
batch_composition = '/projects/I20240005/rnouaj/recovered_from_git/Results_workloads_deucalion/object_detection_speedy/batch_compo/batch_composition.csv'
def do_train(
    model,
    data_loader,
    optimizer,
    ...
    for iteration, (images, targets, idx, tags) in enumerate(data_loader, start_iter):
        if iteration == 0:
        ...
        with open(batch_composition, 'a', newline='') as csvfile:
                ...
                csv_writer.writerow([iteration, tags])
