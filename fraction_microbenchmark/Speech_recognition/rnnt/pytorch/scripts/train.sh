...
: ${DATA_DIR:=${1:-"/projects/I20240005/rnouaj/datasets/LibriSpeech"}}
: ${MODEL_CONFIG:=${2:-"configs/baseline_v3-1023sp.yaml"}}
: ${OUTPUT_DIR:=${3:-"/projects/I20240005/rnouaj/backup_copy/Results_workloads_deucalion/fraction_microbenchmark/Speech_recognition/rnnt/pytorch/results"}}
: ${CHECKPOINT:=${4:-}}
: ${CUDNN_BENCHMARK:=true}
: ${NUM_GPUS:=4}
: ${AMP:=false}
: ${GLOBAL_BATCH_SIZE:=12} # 4 GPUs x 12 batch size
: ${VAL_BATCH_SIZE:=4}
...
python ${DISTRIBUTED} train_speedy.py ${ARGS}
