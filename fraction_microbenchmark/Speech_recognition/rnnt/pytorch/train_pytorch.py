...
from common.data.pytorch_dataset import AudioDataset
...
def main():
    ...
    train_dataset = AudioDataset(data_dir=args.dataset_dir, manifest_fpaths=args.train_manifests, tokenizer=tokenizer, normalize_transcripts=True, heavy_fraction=.75)
...
if __name__ == "__main__":
    ...
    throughput_file = 'results/outputs_fraction/fraction75/pecan_lfrac75.csv'
