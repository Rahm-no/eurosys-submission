...
# plt.legend()
plt.tight_layout()
plt.savefig(out_dir / 'fig_batchcomp_ssd_categories.pdf', dpi=300, bbox_inches="tight")
plt.close()
...
plt.tight_layout()
plt.savefig(out_dir / f"fig_batchcomp_ssd_timeline_{iter_min}_{iter_max}.pdf", dpi=300, bbox_inches="tight")
plt.close()
