...
# Plot each line
ax.plot(df_avg2['iteration_time'], df_avg2['throughput(MBs)'], linestyle='-', label='Pytorch', color=colors['PyTorch'])
ax.plot(df_avg3['iteration_time'], df_avg3['throughput(MBs)'],  linestyle='-', label='PECAN', color=colors['PECAN'])
ax.plot(df_avg0['iteration_time'], df_avg0['throughput(MBs)'], linestyle='-', label='DALI', color=colors['DALI'])
ax.plot(df_avg['iteration_time'], df_avg['throughput(MBs)'], linestyle='-', label='SpeedyLoader', color=colors['Speedy'])
...
plt.tight_layout()
plt.savefig("throughput_object_detection_A100_1.pdf", bbox_inches='tight', dpi=300)
plt.show()