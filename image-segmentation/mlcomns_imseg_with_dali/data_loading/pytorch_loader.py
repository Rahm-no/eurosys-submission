...
class RandBalancedCrop:
    ...
    def _rand_crop(self, image, label):
        ...
        print(f"low_x: {low_x}, high_x: {high_x}, cropped size (X-dim): {high_x - low_x}")
...
class PytTrain(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        print('lbl shape', data['label'].shape)




        data = self.rand_crop(data)
        print('image shape after crop', data['image'].shape)
        print('lbl shape after crop', data['label'].shape)
